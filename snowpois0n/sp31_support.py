...
def install_ifile(*args):
    if os.name == "nt":
        os.system("adb install snowpois0n\\apk\\android_4.2\\com.ifile.apk")
    else:
        os.system("adb install snowpois0n/apk/android_4.2/com.ifile.apk")
...
def jailbreak_older(*args):
    if os.name == "nt":
        ...
        os.system("adb install snowpois0n\\apk\\android_4.2\\ac-market-3-2-3.apk")
